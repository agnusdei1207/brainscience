...
> **핵심**: 운영체제 프로파일링 및 트레이싱 도구는 커널 및 사용자 공간의 실행 흐름을 하드웨어 성능 카운터 (PMC, Performance Monitoring Counter)나 정적/동적 프로브 (Probe)를 통해 기록하여, 시스템의 성능 병목과 이상 동작을 분석하는 가시성 (Observability) 도구다.
