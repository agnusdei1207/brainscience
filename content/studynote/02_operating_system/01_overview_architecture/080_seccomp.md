...
> **핵심**: Seccomp (Secure Computing mode)는 리눅스 커널에서 프로세스가 실행할 수 있는 시스템 호출 (System Call)의 범위를 제한하여, 애플리케이션의 비정상적인 동작이나 공격자가 탈취한 프로세스를 통한 2차 피해를 원천 차단하는 강력한 샌드박싱 (Sandboxing) 메커니즘이다.
