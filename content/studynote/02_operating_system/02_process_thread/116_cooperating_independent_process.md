...
> **핵심**: 독립적 프로세스 (Independent Process)는 다른 프로세스의 실행이나 데이터에 어떠한 영향도 주고받지 않는 단독 실행 단위이며, 협력적 프로세스 (Cooperating Process)는 다른 프로세스와 데이터, 자원, 또는 실행 타이밍을 공유하며 상호 작용하는 프로세스다.
