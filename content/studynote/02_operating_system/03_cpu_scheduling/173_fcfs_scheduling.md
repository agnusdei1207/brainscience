...
> **핵심**: FCFS (First-Come, First-Served) 스케줄링은 준비 큐 (Ready Queue)에 가장 먼저 도착한 프로세스에게 우선적으로 CPU를 할당하고, 자발적으로 종료하거나 I/O를 요청할 때까지 절대로 뺏지 않는 단순 무식한 비선점형 (Non-preemptive) 알고리즘이다.
