...
> **핵심**: 인터럽트 스케줄링 (Interrupt Scheduling)은 하드웨어가 발생시키는 수많은 비동기적 인터럽트 신호(IRQ)들을 운영체제가 어떤 코어에, 어떤 우선순위로, 언제 분배하여 처리할 것인지 결정하는 **커널 최하단부의 자원 분배 메커니즘**이다.
