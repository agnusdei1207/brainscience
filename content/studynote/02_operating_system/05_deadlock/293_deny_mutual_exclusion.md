...
> **핵심**: 교착 상태 예방 관점에서의 상호 배제 부정 (Deny Mutual Exclusion) 기법은 데드락의 1원인인 "비공유적 독점 점유 모드(Non-sharable Exclusive Lock)"를 해체하여, 다수의 운영 프로세스가 제한 없이 자원에 동시 접근(Sharable)할 수 있도록 허용하는 극단적 개방 모델이다.
