...
> **핵심**: 교착 상태 탐지 (Deadlock Detection)는 데드락을 예방하거나 회피하기 위한 사전문지기 역할을 전면 폐기하고, "일단 자원 요구하는 대로 시원하게 막 퍼주고(사고 허용)" **주기적으로 백그라운드 탐지 데몬이 시스템 내 대기 그래프에 얽힌 사이클이 없는지 예나 지금이나 감시하는 사후 감찰 메커니즘**이다.
