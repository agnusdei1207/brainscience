...
> **핵심**: 교착 상태 복구를 위해 누군가를 **생명과 함께 날려버리는(Process Termination)** 대신, 그 녀석의 목숨(스레드 프로세스 자체)은 살려둔 채로 그가 손에 쥐고 있던 **자원(프린터, 락, 디스크 등)만 '폭력적으로 빼앗아(Preempt)' 다른 대기자에게 넘겨주어 사이클(Cycle)을 강제 해소**하는 우회 복구 수단이다.
