...
> **핵심**: PTBR(Page-Table Base Register)은 현재 실행 중인 프로세스의 페이지 테이블 장부가 물리 메모리의 어느 번지에 놓여 있는지 그 **시작 기준 주소를 알려주는 전용 하드웨어 포인터**이며, PTLR(Length Register)은 그 장부의 **총 길이(크기)를 감시하는 보안 가드**다.
