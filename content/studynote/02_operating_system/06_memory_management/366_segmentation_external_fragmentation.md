...
> **핵심**: 세그멘테이션 기법은 논리적 의미(함수, 데이터 등)를 보존하기 위해 조각의 크기를 무작위(가변 크기)로 잘라내기 때문에, 이 조각들을 물리 메모리에 적재하고 해제하는 과정에서 필연적으로 **외부 단편화(External Fragmentation)가 완벽하게 부활**하게 된다.
