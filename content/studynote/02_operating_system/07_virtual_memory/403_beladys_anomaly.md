...
> **핵심**: 벨라디의 모순(Belady's Anomaly)은 컴퓨터에 **물리적 메모리(RAM 프레임)를 더 많이 꽂아주어 공간을 늘려줬음에도 불구하고, 오히려 램이 좁을 때보다 페이지 폴트(Page Fault)가 더 많이 터져버리는 기괴하고 논리적으로 이해 안 되는 시스템 오류 현상**이다.
