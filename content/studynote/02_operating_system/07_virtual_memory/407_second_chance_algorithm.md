...
> **핵심**: 2차 기회 알고리즘(Clock Algorithm)은 가장 무식하고 빠른 **FIFO(원형 큐)의 뼈대 위에, 하드웨어가 제공하는 1비트짜리 '참조 비트(Reference Bit)'를 얹어, 최근에 사용된 페이지에게 한 번 더 살 수 있는 '2차 기회'를 부여**하는 지능형 페이지 교체 알고리즘이다.
