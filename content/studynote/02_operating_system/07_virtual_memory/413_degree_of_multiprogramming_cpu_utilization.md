...
> **핵심**: 이 관계 그래프는 램(RAM)에 동시에 올려놓은 프로그램의 개수(Degree of Multiprogramming)가 늘어날 때, CPU가 얼마나 쉬지 않고 100% 팽팽하게 일하는가(Utilization)를 보여주는 **운영체제 성능 스케줄링의 알파이자 오메가 곡선**이다.
