...
> **핵심**: 문자 장치(Character Device)는 데이터를 4KB 블록 덩어리로 묶어서 관리하는 디스크와 달리, 데이터를 **1바이트(문자) 단위의 연속된 흐름(Stream)으로 쪼르륵 내보내고 받으며, 오직 '순차적(Sequential) 접근'만 허용하는 I/O 장치들의 논리적 분류**다.
