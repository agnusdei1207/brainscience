...
> **핵심**: 사이클 스틸링(Cycle Stealing)은 DMA(Direct Memory Access) 컨트롤러가 메모리로 대량의 데이터를 퍼 나를 때, **가장 중요한 '시스템 버스(System Bus)'의 사용 권한을 CPU가 연산(Decoding 등)을 하느라 0.001초 동안 버스를 쓰지 않는 그 찰나의 빈틈(1클럭)을 훔쳐서 사용하는 교묘한 타이밍 기술**이다.
