...
> **핵심**: 예약 및 단독 장치 접근 제어는 CD-ROM 굽기, 테이프 드라이브, 특수 의료/공업용 로봇팔처럼 **절대로 '스풀링(Spooling)' 꼼수가 통하지 않고, 물리적으로 무조건 한 번에 딱 하나의 프로세스만 점유해야 하는 기계 장치(Exclusive Device)를 커널이 통제하는 잠금(Locking) 시스템**이다.
