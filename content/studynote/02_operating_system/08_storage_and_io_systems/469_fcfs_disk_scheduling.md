...
> **핵심**: FCFS(First-Come, First-Served) 디스크 스케줄링은 수십 개의 디스크 I/O 요청이 큐에 쌓였을 때, 데이터의 물리적 위치(트랙 번호)는 깡그리 무시하고 **오직 큐에 '먼저 도착한 순서(시간)'대로만 디스크 바늘(Head)을 움직여 처리하는 가장 원시적인 큐잉 알고리즘**이다.
