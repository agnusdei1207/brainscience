...
> **핵심**: NAS(Network Attached Storage)는 서버 내부 기판에 디스크 하드를 꽂는 로컬 개념을 버리고, 아예 독립된 스토리지 전용 컴퓨터 박스에 파일 시스템과 네트워크 카드(LAN)를 묶어 이더넷 인터넷망 스위치 허브 IP 망에 띄워 공유하는 **'파일 단위' (File-level) 접근의 범용 외장 스토리지 전용 서버 네트워크 모델**이다.
