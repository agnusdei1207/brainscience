...
> **핵심**: 앞서 배운 직접 접근(Direct Access)이 '주소값으로 한방에 점프'하는 기술이라면, 색인 접근(Indexed Access)은 그 1억 명의 주소록 번호를 모조리 외울 수 없는 인간과 OS를 위해 파일 맨 앞이나 별도 공간에 **"이름표와 물리적 주소 번호표를 짝지어놓은 거대한 사전(Index) 목차"** 를 만들어 제공하는 2단계 S/W 탐색 체계다.
