...
> **핵심**: 기존 1~2단계 디렉터리의 "내 폴더 안에는 파일만 들어올 수 있다"는 답답한 제약을 박살 내고, **"내 폴더(부모) 안에 또 다른 폴더(자식)를 무한정 생성할 수 있다"** 는 재귀적(Recursive) 확장을 이루어낸 현대 Windows/Mac/Linux 파일 시스템의 절대적 근간 구조체(Tree 뼈대)다.
