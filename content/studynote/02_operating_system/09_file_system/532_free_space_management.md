...
> **핵심**: 디스크 철판에 새 파일을 저장하려면, 운영체제(VFS 커널 블록 할당자)는 1TB짜리 광활한 우주 철판 어딘가에 "비어 있는 공간(Free Block)" 이 어디인지 지도를 보고 찾아내야 한다. 파일이 삭제되어 생긴 **파편화된 빈 공간 구멍들을 효과적으로 추적하고 관리하기 위한 장부 쓰기(추적 렌더) 기술** 이다.
