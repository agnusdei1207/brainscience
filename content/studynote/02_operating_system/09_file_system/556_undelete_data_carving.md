...
> **핵심**: 일반 유저가 "파일을 영구 삭제(`Shift+Delete` 또는 `rm -rf` 빔!)" 했다고 믿는 것은, OS 커널이 디스크의 실제 데이터(0과 1의 고기 덩어리)를 지우는 것이 절대 아니라 **"단순히 i-node의 할당 간판 포인터(Free List)만 '빈방 있음' 으로 뜯어버리는 은폐(Hide) 속임수 마스킹"** 에 불과하다. 
