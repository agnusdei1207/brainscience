...
> **핵심**: 침입 탐지 시스템 (IDS, Intrusion Detection System)과 방지 시스템 (IPS, Intrusion Prevention System)은 네트워크 패킷이나 호스트 OS 내부의 이벤트를 분석하여 비정상적인 악성 행위를 식별하고(IDS) 이를 능동적으로 차단하는(IPS) 보안 관제의 핵심 인프라다.
