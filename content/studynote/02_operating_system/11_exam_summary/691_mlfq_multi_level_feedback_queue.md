...
> **핵심**: 다단계 피드백 큐(Multi-Level Feedback Queue, MLFQ)는 운영체제가 각 프로세스의 특성(CPU Bound vs I/O Bound)을 미리 알 수 없다는 한계를 극복하기 위해, **실행 중인 프로세스의 과거 행동을 관찰하고 우선순위 큐(Queue) 사이를 동적으로 이동(천이, Feedback)시키는 현대적 스케줄링 알고리즘**이다.
