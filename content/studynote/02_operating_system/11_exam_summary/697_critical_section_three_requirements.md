...
> **핵심**: 임계 구역(Critical Section)이란 여러 스레드가 공유 자원(변수, 파일)에 접근하여 Race Condition을 유발할 수 있는 '위험한 코드 구간'을 말하며, 이 구간의 동기화를 완벽하게 해결하려면 운영체제가 제시한 **3가지 엄격한 요구조건**을 모두 충족해야만 한다.
