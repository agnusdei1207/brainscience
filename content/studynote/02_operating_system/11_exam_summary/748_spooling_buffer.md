...
> **핵심**: 스풀링 (SPOOLing: Simultaneous Peripheral Operation On-Line)은 CPU같이 속도가 매우 빠른 장치와 프린터처럼 극도로 느리고 독점적인 주변 장치 간의 엄청난 속도 차이를, 거대한 보조 기억장치(디스크)를 중간 버퍼로 사용하여 상쇄하는 I/O 비동기화 기술이다.
