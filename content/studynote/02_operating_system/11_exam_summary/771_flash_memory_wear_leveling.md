...
> **핵심**: 마모 평준화 (Wear Leveling)는 SSD나 USB 플래시 메모리의 낸드(NAND) 셀이 구조적으로 **'쓰기/지우기 횟수 한계(P/E Cycle)'를 가진다는 치명적 결함을 극복하기 위해, 컨트롤러(FTL)가 데이터를 여러 블록에 골고루 분산시켜 기록하는 수명 연장 알고리즘**이다.
