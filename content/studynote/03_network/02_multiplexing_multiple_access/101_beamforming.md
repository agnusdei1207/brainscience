...
> **핵심**: 빔포밍 (Beamforming)은 다수의 안테나 소자에서 방사되는 전파의 위상과 진폭을 조절하여 파동의 간섭을 유도하고, 특정 방향으로만 신호를 날카롭게 집중시키는 공간 필터링 기술이다.
> **비유**: 빔포밍 (Beamforming) - 아날로그/디지털 빔포밍은(는) 다중화와 다중접속 제어 안에서 데이터와 제어 규칙을 질서 있게 맞춰 주는 교통 체계와 같다.
...
**핵심 조건**: 빔포밍 (Beamforming) - 아날로그/디지털 빔포밍은(는) 채널 분할, 슬롯 할당, 충돌 제어 조건을 함께 만족할 때 안정적으로 동작한다.
