...
> **핵심**: 약해진 광신호를 전기 신호로 바꾸지 않고, 희토류 이온의 유도 방출이나 비선형 산란 등 양자역학적 원리를 이용해 광 영역에서 빛의 세기를 그대로 직접 증폭하는 아키텍처다.
> **비유**: 광증폭기 (EDFA, SOA, 라만 증폭기)은(는) 전송 매체와 물리 계층 안에서 데이터와 제어 규칙을 질서 있게 맞춰 주는 교통 체계와 같다.
...
**핵심 조건**: 광증폭기 (EDFA, SOA, 라만 증폭기)은(는) 매체 특성, 감쇠, 간섭 조건을 함께 만족할 때 안정적으로 동작한다.
...
광증폭기 (EDFA, SOA, 라만 증폭기)은(는) 단일 기능으로 끝나지 않고 표준화, 운영 자동화, 고속화·지능화 단계로 확장된다.
