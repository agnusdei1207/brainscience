...
> **비유**: 포니팟 (Honeypot) 허니넷(Honeynet) 유인 분리망 분석 시스템 / 사이버 기만 기술 (Deception Technology)은(는) 광전송과 차세대 자동화 안에서 데이터와 제어 규칙을 질서 있게 맞춰 주는 교통 체계와 같다.
...
**핵심 조건**: 포니팟 (Honeypot) 허니넷(Honeynet) 유인 분리망 분석 시스템 / 사이버 기만 기술 (Deception Technology)은(는) 광전송, 자동화, 분산 제어 조건을 함께 만족할 때 안정적으로 동작한다.
...
기초 광전송과 차세대 자동화 이해
    ↓
포니팟 (Honeypot) 허니넷(Honeynet) 유인 분리망 분석 시스템 / 사이버 기만 기술 (Deception Technology) 개념 정립
    ↓
표준화·상용화 적용
    ↓
자동화·가상화 연계
...
포니팟 (Honeypot) 허니넷(Honeynet) 유인 분리망 분석 시스템 / 사이버 기만 기술 (Deception Technology)은(는) 단일 기능으로 끝나지 않고 표준화, 운영 자동화, 고속화·지능화 단계로 확장된다.
