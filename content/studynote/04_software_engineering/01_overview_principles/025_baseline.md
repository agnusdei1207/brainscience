...
> **핵심**: 기준선(Baseline)은 SCM (Software Configuration Management, 소프트웨어 형상 관리)에서 공식적으로 검토·승인된 형상 항목(CI, Configuration Item)의 집합으로, 변경을 통제하는 기준점이자 향후 개발의 출발점이 되는 공식 스냅샷이다.
