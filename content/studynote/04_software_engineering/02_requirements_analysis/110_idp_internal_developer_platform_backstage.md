...
> **핵심**: IDP(Internal Developer Platform)는 플랫폼 엔지니어링 팀이 구축한 **사내 전용 개발 환경 자판기**로, 앱 개발자가 인프라·보안·CI/CD 지식 없이 **셀프서비스 포털에서 클릭 한 번으로 Golden Path(표준 템플릿) 환경을 즉시 프로비저닝**받는 시스템이다.
