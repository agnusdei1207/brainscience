...
> **핵심**: 요구사항 관리(Requirements Management)는 한 번 확정된 요구사항 문서가 쓰레기통으로 변하는 것을 막기 위해, 스펙을 굳히는 **베이스라인(Baseline)**을 치고, 이후 발생하는 모든 기능의 추가/삭제/수정을 공식적인 **변경 통제(Change Control)** 프로세스에 태워 통제하는 방어 체계다.
