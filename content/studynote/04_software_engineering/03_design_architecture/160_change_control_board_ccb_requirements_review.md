...
> **핵심**: 형상 통제 위원회(Configuration Control Board, CCB)는 소프트웨어 생명주기에서 한 번 확정된 베이스라인(기획서, 코드)을 수정하겠다는 '변경 요청(CR)'이 들어왔을 때, 이를 **기술적/비용적 관점에서 분석하고 승인(Approve) 또는 기각(Reject)을 최종 판결하는 권력(Decision-Making) 집단**이다.
