...
> **핵심**: BPMN(Business Process Model and Notation)은 회사의 결제 승인, 휴가 신청, 환불 처리 같은 **복잡한 비즈니스 업무 흐름(Flow)을, 누구나 이해할 수 있는 동그라미, 네모, 마름모(기호)로 그려내는 국제 표준 순서도(Flowchart) 언어**다.
