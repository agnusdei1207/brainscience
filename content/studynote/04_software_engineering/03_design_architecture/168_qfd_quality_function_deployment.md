...
> **핵심**: QFD(Quality Function Deployment, 품질 기능 전개)는 고객의 모호한 목소리(VOC: Voice of Customer)를 소프트웨어 개발 주기 전체(기획 ➔ 설계 ➔ 코딩 ➔ 테스트)에 걸쳐 **구체적이고 계량 가능한 기술적 파라미터(Engineering Characteristics)로 변환해 나가는 체계적인 행렬(Matrix) 분석 방법론**이다.
