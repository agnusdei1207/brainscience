...
> **핵심**: 품질의 집(HoQ: House of Quality)은 품질 기능 전개(QFD)의 1단계 핵심 도구로, **왼쪽 벽의 '고객의 요구(WHAT)'와 천장의 '기술적 공학 스펙(HOW)'을 십자(Matrix)로 교차시켜, 중앙 방에서 두 항목 간의 상관 점수(1, 3, 9점)를 엑셀 곱셈으로 발라내는 집 모양의 분석 프레임워크**다.
