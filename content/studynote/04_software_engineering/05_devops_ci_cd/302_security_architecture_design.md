...
> **핵심**: 보안 아키텍처(Security Architecture)는 시스템의 데이터와 인프라를 외부 및 내부의 위협으로부터 방어하기 위해, **네트워크, 시스템, 애플리케이션, 데이터의 모든 계층(Layer)에 보안 원칙과 통제(Control) 메커니즘을 구조화하여 배치하는 마스터플랜**이다.
