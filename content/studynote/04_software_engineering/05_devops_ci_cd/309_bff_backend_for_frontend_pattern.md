...
> **핵심**: BFF(Backend For Frontend) 패턴은 1개의 거대한 만능 API 게이트웨이를 두는 대신, **Web, iOS, Android 등 각 프론트엔드(Client)의 화면 특성에 완벽하게 딱 맞춤화(Tailored)된 전용 백엔드(소형 게이트웨이)를 각각 분리하여 두는 마이크로서비스 설계 패턴**이다.
