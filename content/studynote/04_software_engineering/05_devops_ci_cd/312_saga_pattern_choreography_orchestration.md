...
> **핵심**: 사가(Saga) 패턴은 마이크로서비스(MSA)에서 불가능해진 분산 트랜잭션(2PC)의 문제를 해결하기 위해, 거대한 트랜잭션을 **여러 개의 작고 독립적인 로컬 트랜잭션의 연속적인 릴레이로 쪼개어 '결과적 일관성(Eventual Consistency)'을 맞추는 아키텍처 패턴**이다.
