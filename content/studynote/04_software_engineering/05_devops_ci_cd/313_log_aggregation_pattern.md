...
> **핵심**: 로그 취합 아키텍처(Log Aggregation Pattern)는 수십~수백 대의 마이크로서비스(서버, 컨테이너)에 파편화되어 흩어져 있는 텍스트 로그 파일들을, 중앙 집중형 저장소로 실시간 수집, 인덱싱, 시각화하여 **단일 창구(Single Pane of Glass)에서 검색하고 분석할 수 있게 해주는 인프라스트럭처 전술**이다.
