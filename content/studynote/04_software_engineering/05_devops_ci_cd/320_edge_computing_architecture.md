...
> **핵심**: 엣지 컴퓨팅(Edge Computing)은 데이터를 생성하는 소스(IoT 기기, 스마트폰, 공장)와 **가장 가까운 네트워크의 끝자락(Edge)에서 데이터 처리와 연산을 수행**하여, 중앙 클라우드 서버로 데이터를 다 보내지 않고 현장에서 즉각적인 결정을 내리는 분산 아키텍처다.
