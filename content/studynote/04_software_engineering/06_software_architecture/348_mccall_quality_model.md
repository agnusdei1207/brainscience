...
> **핵심**: 맥콜 품질 모델은 1977년 James McCall이 제안한 소프트웨어 품질 모델로, 제품 운영(Product Operation), 제품 수정(Product Revision), 제품 전이(Product Transition)의 3대 관점에서 11개 품질 특성을 평가하는古典적인フレームワークである.
