...
> **핵심**: 할스테드 복잡도(Halstead Complexity)는 Maurice Halstead가 1977년 제안한 소프트웨어 측정법으로, 프로그램 소스 코드의 **연산자(Operator)와 피연산자(Operand)의 개수**를 기반으로 코드 크기, 복잡도, 예상 결함 수를 정량적으로估算하는 지표 체계이다.
