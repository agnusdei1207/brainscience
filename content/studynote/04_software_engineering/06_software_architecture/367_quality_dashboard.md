...
> **핵심**: 품질 대시보드는 소프트웨어 프로젝트의 품질 상태를 한눈에可視화하는集中형 정보 표현 도구로, 결함 현황, 테스트 커버리지, 코드 품질 Metrics, 프로세스 준수율 등 다양한 품질 지표를 실시간 또는定期적으로Dashboard에 현황하여 의사결정자가即각적인 판단을 내릴 수 있도록 지원한다.
