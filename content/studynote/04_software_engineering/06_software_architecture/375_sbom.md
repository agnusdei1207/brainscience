...
> **핵심**: SBOM (Software Bill of Materials)은 소프트웨어 제품에 포함된 모든 구성 요소(서드파티 라이브러리, OSS 컴포넌트, 내부 모듈 등)의 목록으로, 각 구성 요소의 이름, 버전, 라이선스, 출처 등의 메타데이터를 포함한다. 이는 식품의 원재료 표시와類似하여,万一 보안 사고 시 영향 범위를 신속하게 파악할 수 있게 한다.
