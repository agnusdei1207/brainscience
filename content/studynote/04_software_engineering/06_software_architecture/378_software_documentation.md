...
> **핵심**: 소프트웨어 문서화는 소프트웨어 개발, 운영, 유지보수 과정에서 생성되는 모든 문서(요구사항 명세, 설계서, 코드 주석, 사용자 매뉴얼, 운영 가이드 등)를 체계적으로 작성, 관리, 공유하는 활동이다. 문서화는 "소프트웨어의 第二の記憶"로서, 개별 개발자의 머릿속에 있던 지식을 조직적으로蓄積하고共有する。
