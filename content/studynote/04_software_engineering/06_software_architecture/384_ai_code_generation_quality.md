...
> **핵심**: AI 기반 코드 생성 도구(GitHub Copilot, Cursor, Claude 등)는 LLM (Large Language Model)을 활용하여 자동으로 코드, 테스트 케이스, 문서 등을 생성하지만, 생성된 코드는 hallucinations (환각: 사실이 아닌 내용을 사실처럼 생성), 보안 취약점, 논리적 오류, 비효율성 등의 문제를 포함할 수 있어, 이에 대한 체계적 품질 평가가 필수적이다.
