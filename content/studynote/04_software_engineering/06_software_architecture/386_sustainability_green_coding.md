...
> **핵심**: 지속 가능한 소프트웨어 엔지니어링(Sustainable Software Engineering)은 소프트웨어 개발 및 운영의 全단계에서 환경적 영향을 최소화하는 것을 목표로 하며, 그린 코딩(Green Coding)은 보다 적은 에너지를 사용하는 코드를 작성하는 실천이다. 이는 기후변화 대응과 함께 소프트웨어 산업의 환경적 책임에 대한 인식이 커지고 있는背景下에서 중요해졌다.
