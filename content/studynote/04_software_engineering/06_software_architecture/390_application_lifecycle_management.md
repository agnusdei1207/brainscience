...
> **핵심**: 애플리케이션 라이프사이클 관리(ALM, Application Lifecycle Management)는 소프트웨어 애플리케이션의 conception(아이디어 inception)부터 retirement(폐기)까지 전체 생명주기를 통합적으로 관리하는プロセス이며, 요구사항 관리, 개발, 테스트, 배포, 운영, 유지보수, 폐기의 전 단계를 연결한다.
