...
> **핵심**: 살충제 패러독스(Pesticide Paradox)는 농작물에 똑같은 살충제를 계속 뿌리면 해충이 내성을 가져 더 이상 죽지 않듯이, 소프트웨어 테스트에서도 **동일한 테스트 케이스 셋(Set)만 무한 반복하면 새로운 결함(Bug)을 결코 발견할 수 없다**는 테스팅의 핵심 원리다.
