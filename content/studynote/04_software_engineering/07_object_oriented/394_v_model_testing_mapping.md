...
> **핵심**: V-모델(V-Model)은 전통적인 폭포수(Waterfall) 모델이 코딩이 끝난 후에야 테스트를 생각하는 치명적 맹점을 극복하기 위해 제안된 확장 모델로, 개발의 '하향식 설계 단계'와 이에 완벽히 대칭되는 '상향식 테스트 단계'를 알파벳 'V'자 형태로 1:1 대응(Mapping)시킨 소프트웨어 검증 아키텍처다.
