...
> **핵심**: 테스트 케이스(Test Case)는 소프트웨어 테스트를 수행하기 위해 작성되는 최소 단위의 테스트 산출물로, 특정 조건하에서 입력값을 제공하여 기대 결과를 확인하는 구조화된 테스트 시나리오이다. 이는 테스트의 체계적 실행과 결과의 객관적 평가를 가능하게 하는 핵심 문서이다.
