...
> **핵심**: A/B 테스트는 직관이나 임원진의 뇌피셜(HiPPO)에 의존하여 시스템을 설계하는 관행을 부수고, **두 가지 이상(A안, B안)의 실제 버전을 동시 운영하여 실사용자 트래픽을 분산시킨 뒤, 철저한 통계적 검증(전환율, 클릭률)을 통해 우월한 버전을 채택하는 데이터 기반 의사결정 기법**이다.
