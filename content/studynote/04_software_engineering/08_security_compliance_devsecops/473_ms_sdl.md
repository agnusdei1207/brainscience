...
> **핵심**: MS-SDL은 2000년대 초반 "윈도우는 해킹의 동네북"이라는 오명에 빡친 빌 게이츠가 칼을 빼들고 전사적으로 강제 선포한 **'시큐어 코딩(Secure SDLC)의 원조이자 글로벌 바이블'로, 개발의 시작(교육)부터 배포 후 사고 대응까지 7단계의 피도 눈물도 없는 보안 통제 프로세스**다.
