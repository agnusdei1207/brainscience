...
> **핵심**: CWE(Common Weakness Enumeration)는 세상의 모든 해킹 사건의 '근본적인 원인이 되는 개발자의 코딩 멍청함과 설계의 빈틈'들을 **"니네가 자꾸 이런 실수(약점)를 하니까 털리는 거야!"라며 1,000개가 넘는 족보로 묶어 번호(CWE-89 등)를 매겨놓은 전 세계 보안 약점 대백과사전**이다.
