...
> **핵심**: SBOM(소프트웨어 자재 명세서)은 거대한 소프트웨어를 배포할 때, 그 뱃속에 박혀있는 **수천 개의 오픈소스 라이브러리와 직접 짠 코드들의 이름, 버전, 라이선스, 의존성 관계(Tree)를 100% 투명하게 까발려 기계(JSON/XML)가 읽을 수 있도록 만든 '디지털 식품 영양 성분표'**다.
