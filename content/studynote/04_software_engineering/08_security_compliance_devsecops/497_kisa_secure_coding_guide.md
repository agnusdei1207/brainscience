...
> **핵심**: 행안부/KISA 개발 보안 가이드는 외국의 추상적인 족보(CWE, OWASP)를 대한민국 공공기관과 금융권의 현실적인 자바(Java), C 언어 개발 현장에 맞게 씹어서 떠먹여 주는 **'47개의 필수 시큐어 코딩(Secure Coding) 절대 법전이자 한국형 보안 약점 체크리스트'**다.
