...
> **핵심**: 개인정보 보호 중심 설계(PbD)는 앱을 다 만들고 나서 "고객님, 개인정보 털리면 죄송합니다"라며 억지로 방화벽이나 동의서(Checkbox)를 덧붙이는 사후 땜질을 경멸하고, **기획과 아키텍처 설계의 뼈대(첫 번째 블록)부터 '개인정보 보호'를 시스템의 근원적 코어 기능(Default)으로 하드코딩해 넣는 위대한 사상적 선언**이다.
