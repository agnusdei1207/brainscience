...
> **핵심**: 마이크로서비스를 쪼갤 때(Decomposition), 데이터베이스 테이블 구조(명사)나 기술적 층(Layer)을 보고 칼질하는 멍청한 짓을 버리고, 오직 **회사가 돈을 버는 현실 세계의 '조직도(부서)'와 '비즈니스 목적(동사)'을 기준으로 시스템을 세로로 쫙쫙 썰어버리는 직관적인 1차원적 아키텍처 해부술**이다.
