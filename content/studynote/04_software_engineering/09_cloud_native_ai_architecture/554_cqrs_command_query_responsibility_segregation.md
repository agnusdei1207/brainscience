...
> **핵심**: CQRS(Command and Query Responsibility Segregation)는 시스템의 뇌를 세로로 반갈죽하여, 상태를 바꾸는 무거운 **'쓰기(Command) API/DB'**와 상태를 그저 화면에 뿌려주기만 하는 가벼운 **'읽기(Query) API/DB'**를 물리적으로 완전히 찢어버리는 극강의 분할 아키텍처다.
