...
> **핵심**: GitHub Copilot, Cursor 같은 LLM 기반 코드 생성 툴은, 깃헙(GitHub)에 널린 수억 줄의 오픈소스 코드를 씹어 먹고 자란 괴물 AI가 **개발자의 IDE(VS Code 등) 뱃속에 직접 기생하며, 개발자가 치는 타자 1글자, 주석 1줄을 실시간으로 훔쳐보고 다음 100줄을 0.1초 만에 예측(Autocomplete)해 버리는 극강의 페어 프로그래밍(Pair Programming) 봇**이다.
