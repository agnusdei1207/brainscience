...
> **핵심**: AI가 단 1초 만에 뱉어낸 환상적인 코드는 무에서 유를 창조한 것이 아니라, 깃헙(GitHub)에 깔린 수억 줄의 남의 오픈소스 코드를 씹어 먹고 토해낸 '파생물'이다. 만약 **전염성이 극악인 GPL 라이선스 코드를 AI가 그대로 복붙해 줬는데 회사가 그걸 상용 제품에 썼다간, 회사 전체 소스코드를 무료로 강제 공개해야 하는 끔찍한 저작권 위반(법무) 셧다운 사태**에 직면하게 된다.
