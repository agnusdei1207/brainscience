...
> **핵심**: 객체지향의 심장인 SOLID 5원칙은 스파게티 똥 코드를 짜던 개발자들에게 내려진 로버트 C. 마틴(Uncle Bob)의 절대 헌법으로, **"코드를 수정할 때 기존 코드를 뜯어고치다 버그를 연쇄 폭발시키지 말고, 오직 새로운 코드를 바깥에서 '갈아 끼우기(Plug-in)'만으로 기능을 무한 확장하게 만드는 궁극의 유연성(Flexibility) 설계술"**이다.
