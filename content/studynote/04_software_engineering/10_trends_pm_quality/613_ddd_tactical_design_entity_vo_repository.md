...
> **핵심**: 도메인 주도 설계(DDD)의 전술적(Tactical) 설계는, 더러운 DB 쿼리(SQL) 중심으로 비즈니스를 짜던 낡은 관행을 박살 내고 **오직 순수한 자바 객체(POJO)들끼리 핑퐁을 치며 비즈니스 룰을 방어하는 '풍부한 도메인 모델(Rich Domain Model)'의 실전 코딩 헌법**이다.
