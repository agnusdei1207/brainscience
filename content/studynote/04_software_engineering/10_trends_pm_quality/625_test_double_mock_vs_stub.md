...
> **핵심**: 테스트 더블(Test Double)은 단위 테스트(Unit Test)를 수행할 때 실제 데이터베이스나 외부 API 등 제어하기 힘든 의존성을 대신하여 동작하는 '가짜 객체'의 총칭이며, 그중 대표적인 것이 **Stub(상태 기반 테스트)**과 **Mock(행위 기반 테스트)**이다.
