...
> **핵심**: 회귀 테스트(Regression Testing)는 소프트웨어에 새로운 기능이 추가되거나 기존 버그가 수정되었을 때, 이 변경 사항이 **원래 정상적으로 작동하던 기존 기능들을 망가뜨리지 않았는지(Side-effect)** 확인하기 위해 예전 테스트 케이스를 다시 반복해서 돌려보는 활동이다.
