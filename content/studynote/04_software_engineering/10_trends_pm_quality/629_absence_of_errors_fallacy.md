...
> **핵심**: 오류 부재의 궤변(Absence of Errors Fallacy)은 소프트웨어 테스팅의 7대 원칙 중 하나로, **"소프트웨어 내의 모든 버그(결함)를 100% 완벽하게 찾아내어 수정했더라도, 그 소프트웨어가 사용자의 실제 요구사항(Business Needs)과 다르다면 아무 짝에도 쓸모없다"**는 품질 관리의 역설적 진리다.
