...
> **핵심**: ISO/IEC 25010(SQuaRE)은 "이 소프트웨어가 좋은 소프트웨어인가?"라는 주관적인 질문에 대해, 인간의 기분을 배제하고 **기능성, 신뢰성, 사용성, 성능 효율성, 유지보수성, 이식성, 보안성, 호환성**이라는 8개의 객관적이고 측정 가능한 잣대(Metrics)를 들이미는 전 세계 공통의 품질 헌법이다.
