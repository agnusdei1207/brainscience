...
> **핵심**: 오류 부재의 궤변 (Absence of Errors Fallacy)은 소프트웨어 테스팅의 7가지 원리 중 하나로, 시스템 내부에 결함 (Defect)이 완전히 제거되어 기술적으로 무결하더라도 사용자의 비즈니스 요구사항이나 사용 목적을 충족하지 못한다면 품질 측면에서 실패한 것임을 의미한다.
