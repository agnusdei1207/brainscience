...
> **핵심**: 해시 인덱스(Hash Index)는 가나다순으로 차곡차곡 정리(정렬)하는 B-Tree와 달리, 찾고자 하는 키워드(예: '홍길동')를 **무작위 난수 믹서기(해시 함수)에 갈아 넣어 나오는 '고유한 숫자(버킷 주소)'에 데이터를 때려 박고, 찾을 때도 계산 1방에 즉시 주소로 직행하는 다이렉트 탐색 구조**다.
