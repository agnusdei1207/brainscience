...
> **핵심**: 클러스터드 인덱스(Clustered Index)는 책의 맨 뒤에 부록으로 달아놓는 '찾아보기'가 아니라, **책의 본문 페이지 자체를 가나다순(A~Z)으로 처음부터 끝까지 쫙 오려 붙여 강제 정렬(Sort)해버리는 데이터베이스 원본 테이블 그 자체의 영혼(물리적 저장 뼈대)**이다.
