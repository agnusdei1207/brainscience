...
> **핵심**: 규칙 기반 옵티마이저(RBO, Rule-Based Optimizer)는 SQL 쿼리를 실행할 길을 정할 때, 데이터의 양이나 인덱스 크기 따위는 일절 무시하고 오직 **사전에 하드코딩된 '15개의 불변하는 우선순위 계급표(Rule Rank)'에 100% 맹목적으로 순종하여 무지성 경로(Execution Plan)를 확정하는 구형 쇳덩이 두뇌**다.
