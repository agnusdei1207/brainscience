...
> **핵심**: 데이터 마트(Data Mart)는 전사 데이터를 무식하게 욱여넣은 거대하고 느린 데이터 웨어하우스(DW) 대신, **마케팅팀, 재무팀, 인사팀 등 특정 부서(Department)나 특정 업무의 입맛에 딱 맞게 데이터를 잘게 소분하여 별 모양(Star Schema)으로 예쁘게 깎아놓은 빠르고 민첩한 소규모 분석 저장소**다.
