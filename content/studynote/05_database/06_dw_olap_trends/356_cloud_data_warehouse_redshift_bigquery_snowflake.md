...
> **핵심**: 클라우드 데이터 웨어하우스(Cloud DW) 솔루션 3대장은, 기업의 수십~수백 테라바이트(TB) 규모의 방대한 비즈니스 정형/반정형 데이터를 단일 공간에 모아놓고 CEO의 대시보드를 위한 복잡한 SQL 분석(OLAP) 쿼리를 빛의 속도로 처리해 내는 **차세대 거대 분석 인프라**다.
