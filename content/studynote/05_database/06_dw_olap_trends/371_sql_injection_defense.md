...
> **핵심**: SQL 인젝션 (SQL Injection)은 공격자가 입력 폼이나 URL 파라미터에 악의적인 SQL (Structured Query Language) 구문을 삽입하여, 백엔드 데이터베이스가 원래 의도와 다르게 쿼리를 해석하고 실행하도록 조작하는 치명적인 코드 주입 공격이다.
