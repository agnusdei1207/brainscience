...
> **핵심**: 데이터 옵스 (DataOps)는 소프트웨어 엔지니어링의 DevOps 철학(애자일, CI/CD, 협업)을 데이터 파이프라인 생명주기에 적용하여, 데이터 분석가부터 엔지니어, 비즈니스 사용자 간의 단절(Silo)을 허물고 고품질 데이터를 신속하게 제공하는 개발 및 운영 문화다.
