...
> **핵심**: CDP (Customer Data Platform)는 웹사이트, 모바일 앱, 오프라인 POS 매장, 콜센터 등 수많은 채널에 파편화되어 흩어진 고객 데이터를 실시간으로 수집하고 단일한 고객 프로필(Unified Profile)로 조립하여, 마케터가 개발자의 도움 없이 직접 타겟팅 액션을 실행할 수 있게 해주는 **'고객 중심 행동(Action) 데이터 엔진'**이다.
