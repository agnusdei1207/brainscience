...
> **핵심**: 데이터 클린룸 (Data Clean Room, DCR)은 두 개 이상의 기업이 뼈아프게 수집한 퍼스트 파티 고객 데이터를 공유하고 결합(Join)할 때, 서로의 원본 데이터(Raw Data)나 고객의 개인정보를 절대 열람하지 못하도록 통제된 클라우드 내의 '암호화된 안전 결합 구역' 아키텍처다.
