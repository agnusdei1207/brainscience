...
> **핵심**: 데이터 카탈로그(Data Catalog)는 기업의 클라우드, 온프레미스, SaaS 시스템에 흩어져 있는 수만 개의 테이블과 파일에 대한 기술적 속성(메타데이터)을 자동으로 긁어모아, 비즈니스 친화적인 용어집(Glossary)과 결합시켜 구글 검색처럼 누구나 쉽게 데이터를 찾게 해주는 **사내 데이터 중앙 도서관 명세서**다.
