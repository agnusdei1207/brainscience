...
> **핵심**: 개인정보 비식별 조치는 준식별자 (Quasi-Identifier) 조합을 통한 재식별 공격을 방어하기 위해, 데이터를 일반화(Generalization)하고 억제(Suppression)하여 프라이버시 모델(K-익명성, l-다양성, t-근접성)을 만족시키는 수학적 데이터 보존 기법이다.
