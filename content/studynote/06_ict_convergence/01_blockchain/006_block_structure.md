...
> **핵심**: 블록은 블록체인 네트워크에서 거래 데이터를 저장하는 기본 단위이며, 블록 헤더(Block Header)와 블록 바디(Block Body)로 구성된다. 블록 헤더는 메타데이터를, 바디는 실제 거래 목록을 포함하며, 각 블록은 이전 블록의 해시값으로 연결되어 사슬 구조를 형성한다.
