...
> **핵심**: 프라이빗 5G(특화망)는 통신 3사(SKT, KT, LG U+)의 전국 상용망(Public 5G)을 빌려 쓰는 대신, 일반 기업(네이버, 삼성 등)이나 공공기관이 특정 지역(공장, 병원, 사옥)에 직접 주파수를 할당받아 오직 자기 회사만의 목적을 위해 독자적으로 구축 및 운영하는 완전히 독립된 사설 5G 네트워크다.
