...
> **핵심**: 스마트 시티 플랫폼은 도시 전역에 깔린 IoT 센서, CCTV, 스마트 가로등에서 쏟아지는 방대한 비정형 데이터를 중앙의 거대한 '데이터 허브(Data Hub)'로 빨아들여, 교통, 방범, 환경, 에너지 등 개별적으로 놀던 도시 인프라를 하나의 거대한 뇌(AI)로 통합 제어하는 도시 운영 체제(Urban OS)다.
