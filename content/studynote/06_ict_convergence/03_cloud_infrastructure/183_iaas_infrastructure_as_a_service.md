...
> **핵심**: IaaS (Infrastructure as a Service)는 CPU, 메모리, 스토리지, 네트워크 방화벽 등 데이터센터의 거대한 쇳덩어리(물리적 하드웨어)들을 하이퍼바이저(Hypervisor) 기반의 가상화 기술로 쪼개어, 인터넷을 통해 1분 만에 임대해 주는 클라우드 컴퓨팅의 가장 밑바닥 기초 공사 모델이다.
