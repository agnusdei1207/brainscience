...
> **핵심**: SaaS (Software as a Service)는 소프트웨어를 CD나 USB로 '구매(Purchase)'하여 내 컴퓨터에 설치하던 과거의 소유 경제를 박살 내고, 클라우드 제공자가 서버부터 애플리케이션 코드까지 100% 구축해 둔 완제품을 웹 브라우저를 통해 '구독(Subscription)'하는 가장 진화된 클라우드 서비스 모델이다.
