...
> **핵심**: 도커(Docker)는 리눅스의 어려운 내장 기술(cgroup, namespace)을 활용해 앱을 격리하는 컨테이너 가상화(194번)를, 누구나 쉽게 `docker run` 명령어 한 줄로 띄우고 지울 수 있도록 예쁘게 포장해 낸 **'컨테이너 런타임 및 이미지 패키징 표준 플랫폼'**이다.
