...
> **핵심**: 클라우드 네이티브(Cloud Native)는 단순히 사내 전산실 서버를 아마존(AWS) 깡통 서버로 짐 싸서 이사 가는 짓(Lift & Shift)을 혐오하며, **애플리케이션을 기획하고 코드를 짜는 뼛속 첫 단계부터 클라우드의 무한 탄력성(Elasticity)과 유연성을 100% 뽑아먹기 위해 최적화하는 궁극의 소프트웨어 철학**이다.
