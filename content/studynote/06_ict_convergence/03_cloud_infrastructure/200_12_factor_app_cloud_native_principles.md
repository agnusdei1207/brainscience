...
> **핵심**: 12-Factor App은 초창기 클라우드 PaaS의 선구자인 헤로쿠(Heroku)의 엔지니어들이, 수백만 개의 앱을 호스팅하며 깨달은 **"어떤 클라우드 환경에 던져놔도 버그 없이 돌아가고 무한히 확장(Scale-out)할 수 있는 소프트웨어를 짜는 12가지 황금 법칙(Best Practices)"**이다.
