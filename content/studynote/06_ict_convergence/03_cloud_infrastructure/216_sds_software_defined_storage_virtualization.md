...
> **핵심**: SDS(Software Defined Storage)는 EMC나 넷앱(NetApp)이 파는 수억 원짜리 전용 하드웨어 스토리지(SAN/NAS) 장비의 종속성을 파괴하고, 용산에서 파는 **싸구려 x86 깡통 서버 수십 대에 꽂힌 일반 하드디스크들을 소프트웨어로 하나로 묶어 거대한 '무한대의 가상 디스크(Pool)'로 연성해 내는 마법**이다.
