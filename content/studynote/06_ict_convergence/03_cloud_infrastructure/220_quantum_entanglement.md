...
> **핵심**: 양자 얽힘(Quantum Entanglement)은 물리적으로 한 번 짝지어진 두 개의 큐비트(양자 입자)가, 하나는 지구에 두고 다른 하나는 안드로메다은하로 가져가더라도 **한쪽을 관측(0 또는 1로 결정)하는 그 찰나의 순간, 수백만 광년 떨어진 나머지 한쪽도 빛의 속도를 뛰어넘어 즉시 반대 상태로 확정되어 버리는 기괴한 원격 동기화 현상**이다.
