...
> **핵심**: 쇼어 알고리즘(Shor's Algorithm)은 전 세계 은행과 인터넷을 지키는 RSA 암호화의 방패인 '거대한 소인수분해의 수학적 어려움'을, 덧셈/곱셈의 노가다가 아니라 **'주기(Period)를 찾는 파동의 문제'로 기하학적으로 치환해 버린 천재적인 양자 수학 공식**이다.
