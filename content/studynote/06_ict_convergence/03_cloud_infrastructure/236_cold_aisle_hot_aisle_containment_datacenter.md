...
> **핵심**: 콜드/핫 아일(Aisle) 아키텍처는 데이터센터의 서버 랙(Rack)들이 찬 바람을 먹고 뜨거운 바람을 뱉는 방향을 한쪽으로 통일하여 마주 보게 배열한 뒤, 그 사이에 유리 천장과 문(Containment)을 달아 **'차가운 공기'와 '뜨거운 공기'가 섞이지 않도록 물리적으로 완벽히 격리(Isolation)하는 유체 열역학 공조 설계**다.
