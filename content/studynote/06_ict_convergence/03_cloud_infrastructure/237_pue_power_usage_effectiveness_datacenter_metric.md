...
> **핵심**: PUE(Power Usage Effectiveness)는 데이터센터에 들어온 전체 전기 중에서, 오직 '순수하게 컴퓨터(IT 장비)를 돌리는 데 쓰인 전기'의 비율을 측정하는 **인프라 냉각(Cooling) 및 전력 손실 방어의 궁극적인 채점 성적표**다. (1.0에 가까울수록 신의 경지).
