...
> **핵심**: 클라우드 재해 복구(DR, Disaster Recovery) 아키텍처는 서울 데이터센터가 벼락을 맞아 완전히 증발했을 때, 일본이나 미국 데이터센터에서 **얼마나 빨리(RTO) 그리고 데이터를 얼마나 안 잃어버리고(RPO) 부활할 수 있는가**를 설계하는 생존의 수학이자 돈(비용)의 저울질이다.
