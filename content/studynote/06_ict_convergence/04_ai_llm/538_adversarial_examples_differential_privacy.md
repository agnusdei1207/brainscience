...
> **핵심**: 적대적 예제(Adversarial Example)는 인간이 인지하지 못하는 미세한 입력 변조로 AI 모델을 오분류시키며, 차분 프라이버시(Differential Privacy, DP)는 ε-DP 정의로 데이터 개인정보를 수학적으로 보장하는 별개이지만 상호보완적인 AI 보안 기술이다.
