...
> **핵심**: 주성분 분석(PCA, Principal Component Analysis)은 수백 개의 변수(차원)가 얽혀있는 복잡한 데이터를, 데이터가 가장 넓게 퍼져있는(분산이 큰) 방향의 축(주성분)을 찾아내어 원래 정보의 손실을 최소화하면서 2~3개의 압축된 차원으로 찌그러뜨리는 수학적 마술이다.
