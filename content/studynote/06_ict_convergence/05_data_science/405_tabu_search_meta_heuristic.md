...
> **핵심**: 타부 서치(Tabu Search)는 지역 최적해(Local Minima)에 갇히는 것을 막기 위해, 한 번 가봤거나 나쁜 결과를 냈던 길(경로)을 '금기 목록(Tabu List)'에 적어두고 일정 기간 동안은 절대 그 길로 다시 돌아가지 못하게 강제하는 인간의 '단기 기억' 모방 알고리즘이다.
