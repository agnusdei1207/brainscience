...
> **핵심**: 온톨로지(Ontology)는 철학의 '존재론'에서 빌려온 개념으로, 세상의 모든 사물(개념)들이 서로 어떤 관계(속성)를 맺고 있는지를 컴퓨터가 이해할 수 있는 단어 사전과 거미줄(그래프) 모양으로 엮어놓은 지식 표현(Knowledge Representation) 아키텍처다.
