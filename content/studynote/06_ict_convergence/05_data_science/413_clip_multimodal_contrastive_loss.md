...
> **핵심**: CLIP(Contrastive Language-Image Pre-training)은 인터넷에 널려 있는 "사진"과 "그 밑에 달린 텍스트 설명"의 쌍(Pair) 4억 개를 통째로 가져와, 컴퓨터가 글자와 그림을 같은 언어로 이해하도록 두 데이터의 벡터 공간을 완벽하게 겹쳐버리는(정렬) 다중 모달(Multimodal) AI다.
