...
> **핵심**: 분석 CRM(Analytical CRM)은 운영 CRM이 수집한 대규모 고객 데이터를 **데이터 웨어하우스(DW)에 적재하고 AI/데이터 마이닝으로 분석**하여, "누가 이탈할 것인가?", "어떤 상품을 추천할 것인가?"라는 **예측적 통찰(Predictive Insight)**을 추출하는 두뇌 시스템이다.
