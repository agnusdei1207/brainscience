...
> **핵심**: gRPC(Google Remote Procedure Call)는 HTTP/2 기반 고성능 RPC 프레임워크로, Protocol Buffers(Protobuf)라는 이진 직렬화 스키마를 사용하여 REST/JSON 대비 3~10배 빠른 성능과 강타입(Strongly-typed) 계약을 제공한다.
