...
> **핵심**: CoAP(Constrained Application Protocol)은 UDP 기반 RESTful 메서드(GET/POST/PUT/DELETE)를 제공하는 IoT 경량 프로토콜로, HTTP의 의미론을 8byte 최소 헤더로 구현하여 MCU(Microcontroller)급 제약 환경에 적합하다.
