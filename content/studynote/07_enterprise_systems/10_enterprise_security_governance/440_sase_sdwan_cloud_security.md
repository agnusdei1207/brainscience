...
> **핵심**: SASE(Secure Access Service Edge)는 Gartner(2019)가 정의한 클라우드 네이티브 네트워크 보안 아키텍처로, SD-WAN(소프트웨어 정의 WAN)과 보안 서비스(ZTNA·SWG·CASB·FWaaS)를 단일 클라우드 플랫폼에서 통합 제공한다.
