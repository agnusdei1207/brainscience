...
> **핵심**: 정성적 위험 분석(Qualitative Risk Analysis)은 위험을 High/Medium/Low 또는 1~5 척도로 정의하고 위협 발생 가능성(Likelihood)과 영향도(Impact)를 주관적으로 평가하여 위험 매트릭스(Risk Matrix)에 위치시키는 방법론이다.
