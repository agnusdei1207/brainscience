...
> **핵심**: IND-CCA2 (Indistinguishability under Adaptive Chosen Ciphertext Attack)는 해커가 실시간으로 조작된 암호문을 해독 서버(오라클)에 던져 에러 반응을 수집하는 극한의 공격 환경에서도 평문의 힌트를 전혀 얻을 수 없는 궁극의 안전성 상태다.
