...
> **핵심**: 브릿지 CA(Bridge CA, BCA)는 서로 다른 인증 기관(CA, Certificate Authority) 도메인들이나 독립적인 공개키 기반 구조(PKI, Public Key Infrastructure) 도메인 간의 신뢰를 연결해 주기 위해, 중앙에 위치하여 상호 인증서(Cross-Certificate)를 발급하는 허브(Hub) 역할의 최상위 브릿지 기관이다.
