...
> **핵심**: 앞서 앱 서명의 영속성 도구로 TSA를 다뤘다면, 넓은 의미의 **TSA(Time Stamping Authority)**와 **RFC 3161** 표준은 단순히 코드 서명을 넘어, 범용적인 전자문서(계약서, 전자어음 등)가 **"정확히 언제, 어떤 내용으로 존재했는가?"를 제3의 공인된 시계(Atomic Clock)와 암호학적 해시를 통해 법적으로 증명(Proof of Existence)**하는 핵심 PKI 인프라다.
