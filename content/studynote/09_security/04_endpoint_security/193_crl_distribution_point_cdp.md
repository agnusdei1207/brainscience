...
> **핵심**: CDP(CRL Distribution Point)는 전 세계의 웹 브라우저나 운영체제가 특정 디지털 인증서의 '현재 생존 여부(폐기되지 않았는지)'를 묻기 위해 다운로드해야 하는 **블랙리스트 파일(CRL, Certificate Revocation List)이 저장된 정확한 웹 서버의 URL 주소(위치 포인터)**를 인증서 내부에 강제로 박아 넣은 X.509 확장 필드다.
