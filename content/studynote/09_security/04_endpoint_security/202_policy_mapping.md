...
> **핵심**: 정책 매핑(Policy Mapping)은 공개키 기반 구조(PKI)에서 서로 독립적인 인증기관(CA, Certificate Authority) 간 교차 인증(Cross-Certification)을 수행할 때, 각 도메인의 인증서 정책(CP, Certificate Policy)을 서로 동등한 효력으로 매칭해 주는 X.509 v3 확장 메커니즘이다.
