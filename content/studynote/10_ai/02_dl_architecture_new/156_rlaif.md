...
> **핵심**: RLAIF (Reinforcement Learning from AI Feedback)는 인간이 직접 텍스트 답변의 순위를 매기던 RLHF의 비용과 속도 한계를 극복하기 위해, 인간 대신 **'더 거대하고 똑똑한 교사 AI(예: GPT-4)'가 피드백 평가와 채점을 대행**하게 하는 모델 정렬(Alignment) 기법이다.
