...
> **핵심**: 타겟 네트워크 (Target Network)는 딥러닝 강화 학습(DQN) 시 요동치는 정답 과녁(Target) 때문에 학습이 파탄 나는 것을 막기 위해, 정답을 계산하는 뇌(Target Net)와 학습하는 뇌(Main Net)를 둘로 복제하여 **'정답 과녁을 일정 시간 동안 꽁꽁 얼려두는(Freezing)'** 인프라 안정화 기법이다.
