...
> **핵심**: A3C (비동기 어드밴티지 액터-크리틱)는 수십 마리의 에이전트를 병렬로 띄워 경험을 모으는 '분산 강화 학습'의 선구자이며, PPO (Proximal Policy Optimization)는 A3C의 불안정성을 잡기 위해 정책(Actor 뇌)이 한 번에 너무 크게 변하지 못하도록 클리핑(Clipping) 족쇄를 걸어 훈련 붕괴를 막은 오픈AI의 마스터피스다.
