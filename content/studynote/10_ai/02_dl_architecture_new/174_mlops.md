...
> **핵심**: MLOps (Machine Learning Operations)는 실험실 안의 데이터 과학자 1~2명이 노트북으로 돌리던 머신러닝 코드를, 실제 서비스(Production) 환경에서 수백만 명이 끊김 없이 안정적으로 쓸 수 있도록 모델 훈련, 테스트, 배포, 유지보수의 전체 생명주기를 자동화하는 인프라 철학이다.
