...
> **핵심**: MLflow는 아파치 스파크(Apache Spark)를 만든 데이터브릭스(Databricks)가 주도하는 오픈소스 플랫폼으로, 머신러닝 개발 과정에서 수백 번 바뀌는 소스 코드, 데이터, 하이퍼파라미터, 성능 점수(Metric)를 꼼꼼하게 기록하고 모델 버전을 깔끔하게 포장(Packaging)해 주는 **'AI 연구원의 실험 일지 겸 모델 도서관'**이다.
