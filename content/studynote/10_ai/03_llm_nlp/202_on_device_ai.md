...
> **핵심**: 온디바이스 AI (On-Device AI)는 사용자의 스마트폰, 노트북, 자율주행차 안에서 **외부 클라우드 인터넷(Wi-Fi, 5G) 연결 없이 오직 기기 자체에 내장된 칩셋(NPU/GPU)만으로 인공지능 추론(Inference)을 100% 로컬에서 돌려버리는 독립 생태계 기술**이다.
