...
> **핵심**: 슬림 언어 모델 (SLM, Small Language Model)은 수천억 개의 뇌세포(파라미터)를 가진 거대 공룡 모델(LLM)의 덩치를 수십억 개(1B~8B) 수준으로 극단적으로 깎아내린 대신, 쓰레기 데이터를 버리고 '교과서 같은 초고품질 데이터'만 먹여 키운 **작지만 무섭게 매운 천재 꼬마 트랜스포머**다.
