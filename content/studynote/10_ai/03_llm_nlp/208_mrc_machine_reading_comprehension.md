...
> **핵심**: 기계 독해 (MRC, Machine Reading Comprehension)는 인공지능이 인간처럼 수백 장짜리 교과서(Context 본문)를 쭉 훑어 읽은 뒤, 사용자가 질문(Question)을 던지면 **본문 속에서 정확한 정답이 있는 텍스트 구역의 '시작점과 끝점(Start/End Span)'을 빨간펜으로 쫙 밑줄 그어 발췌(Extraction)**해 내는 고도의 텍스트 추론 아키텍처다.
