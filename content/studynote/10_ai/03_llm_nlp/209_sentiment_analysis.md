...
> **핵심**: 감성 분석 (Sentiment Analysis)은 인공지능이 인간이 작성한 텍스트(리뷰, 트윗, 기사)의 행간에 숨겨진 감정 상태를 **'긍정(Positive)', '부정(Negative)', '중립(Neutral)'이라는 통계적 스코어(Score)**로 발라내는 자연어 처리(NLP) 분류 기술의 꽃이다.
