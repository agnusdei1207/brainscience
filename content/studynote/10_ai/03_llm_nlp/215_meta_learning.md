...
> **핵심**: 메타 러닝 (Meta Learning)은 단순히 '고양이를 알아보는 법(일반 딥러닝)'을 배우는 것이 아니라, **"내가 낯선 것을 마주쳤을 때 어떻게 하면 10분 만에 빠르게 배울 수 있는가?"라는 '배우는 방법 그 자체(Learning to Learn)'**를 통달하도록 뇌(신경망 가중치 초기값)를 훈련시키는 궁극의 상위 차원 알고리즘이다.
