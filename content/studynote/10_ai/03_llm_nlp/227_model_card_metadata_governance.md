...
> **핵심**: 모델 스코어카드(Model Card)는 수십억 개의 파라미터가 꼬여있는 정체불명의 블랙박스 AI 모델이 도대체 **누가 만들었고, 어떤 훈련 데이터(스펙)를 먹고 자랐으며, 어느 인종이나 성별에 끔찍한 차별(편향, Bias)을 뿜어낼 수 있는지 그 치부까지 낱낱이 기록해 두는 'AI 모델 전용 영양 성분표이자 부작용 경고장'**이다.
