...
> **핵심**: 퍼지 로직(Fuzzy Logic)은 컴퓨터의 딱딱한 이분법(0 아니면 1, 흑 아니면 백)을 박살 내고, 인간의 언어처럼 **"약간 덥다", "꽤 춥다" 같은 애매모호한(Fuzzy) 상태를 0과 1 사이의 '소속도(Membership Degree)'라는 수학적 확률로 계산하게 만드는 회색 지대의 인공지능**이다.
