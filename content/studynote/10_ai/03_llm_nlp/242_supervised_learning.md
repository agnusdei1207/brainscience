...
> **핵심**: 지도 학습(Supervised Learning)은 수만 개의 문제에 **"이건 정답이야!"라고 인간이 친절하게 라벨(Label)을 꼼꼼히 붙여준 과외 선생님의 완벽한 족보(데이터셋)**를 컴퓨터에 쑤셔 넣고, 기계가 문제와 정답 사이의 비밀 공식을 수학적으로 외워버리게 만드는 가장 원초적이고 강력한 AI 훈련법이다.
