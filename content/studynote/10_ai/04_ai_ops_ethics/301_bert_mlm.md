...
> **핵심**: BERT (Bidirectional Encoder Representations from Transformers)는 Transformer 인코더를 양방향(Bidirectional)으로 학습하여, 각 토큰의 표현을 좌우 양방향 문맥을 동시에 반영해 생성하는 2018년 구글의 사전 학습 언어 모델이다.
