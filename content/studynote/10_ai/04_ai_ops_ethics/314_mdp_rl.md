...
> **핵심**: MDP (Markov Decision Process, 마르코프 결정 과정)는 강화 학습의 수학적 기반으로, 에이전트(Agent)가 환경(Environment)과 상호작용하는 문제를 **상태(State)·행동(Action)·보상(Reward)·전이 확률(Transition Probability)**의 4요소로 정형화하는 프레임워크다.
