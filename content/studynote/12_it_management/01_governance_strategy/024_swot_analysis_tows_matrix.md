...
> **핵심**: SWOT 분석은 조직의 내부 강점(Strengths)·약점(Weaknesses)과 외부 기회(Opportunities)·위협(Threats)을 체계적으로 식별하는 환경 분석 도구이며, TOWS 매트릭스는 이 4개 요소를 교차하여 SO·ST·WO·WT 4가지 전략 방향을 도출하는 전략 수립 도구다.
