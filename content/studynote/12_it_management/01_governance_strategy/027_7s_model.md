...
> **핵심**: 맥킨지 7S 모델(McKinsey 7S Framework)은 조직의 내부 역량을 7가지 요소(Strategy·Structure·Systems·Shared Values·Style·Staff·Skills)로 분석하는 프레임워크로, 조직 변화 관리·디지털 전환·IT 전략 수립 시 내부 정합성(Alignment)을 점검하는 데 활용된다.
