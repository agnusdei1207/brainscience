...
> **핵심**: QA (Quality Assurance, 품질 보증)는 올바른 프로세스를 따르는지 확인하는 **예방 중심** 활동이고, QC (Quality Control, 품질 통제)는 제품/산출물에서 결함을 찾아내는 **발견 중심** 활동이다—QA는 "어떻게 만드는가"를, QC는 "만든 것이 맞는가"를 검증한다.
