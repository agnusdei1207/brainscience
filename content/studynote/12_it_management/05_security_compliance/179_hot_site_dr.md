...
> **핵심**: 핫 사이트(Hot Site)는 프로덕션 환경과 동일한 HW·SW·네트워크를 사전 구축하고 최신 데이터를 실시간 혹은 근실시간으로 복제해 재해 발생 시 RTO (Recovery Time Objective) 4시간 이내 서비스 복구를 보장하는 최고 등급의 DR(Disaster Recovery) 시설이다.
