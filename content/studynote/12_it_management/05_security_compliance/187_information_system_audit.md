...
> **핵심**: 정보시스템 감리(Information System Audit)는 독립된 감리법인이 정보시스템의 개발·운영 전 과정을 효과성(Effectiveness)·효율성(Efficiency)·안전성(Safety)의 3축으로 검토하여 문제점을 발견하고 개선 권고를 제시하는 제3자 품질 보증 제도다.
