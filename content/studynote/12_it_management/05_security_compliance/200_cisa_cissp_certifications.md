+++
weight = 200
title = "200. CISA, CISSP 국제 자격증 (International Security Certifications)"
date = "2026-04-21"
[extra]
...
1. CISA는 "회사 컴퓨터 시스템을 정기적으로 검사하는 검사관 자격증"이야. 의사가 몸을 검사하듯, CISA 전문가는 회사 IT가 규칙대로 돌아가는지 검사해.
2. CISSP는 "보안 분야의 모든 것을 아는 슈퍼 전문가 자격증"이야. 자물쇠부터 CCTV, 경보기, 비상구 설계까지 회사 보안 시스템 전체를 담당해.
3. 두 자격 모두 5년 경험이 있어야 응시할 수 있고, 자격을 받은 뒤에도 매년 공부한 증거를 내야 자격이 유지돼. 한 번 받으면 끝이 아니라 평생 공부하는 진짜 전문가 증명서야.
