...
> **핵심**: 멀티 클라우드(Multi-Cloud)는 여러 CSP (Cloud Service Provider, 클라우드 서비스 공급자)를 동시에 활용하여 벤더 락인(Vendor Lock-in)을 방지하고, 하이브리드 클라우드(Hybrid Cloud)는 온프레미스(On-Premises)와 퍼블릭 클라우드를 연결하여 데이터 주권과 유연성을 동시에 확보하는 전략이다.
