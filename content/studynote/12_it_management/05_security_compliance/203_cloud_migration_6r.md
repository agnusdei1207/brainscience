...
> **핵심**: 클라우드 마이그레이션 6R은 기존 IT 워크로드를 클라우드로 이전하는 방식을 Rehost·Replatform·Refactor·Repurchase·Retire·Retain 6가지로 분류하여, 각 애플리케이션에 최적화된 마이그레이션 경로를 선택하는 의사결정 프레임워크다.
