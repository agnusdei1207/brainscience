...
> **핵심**: 데이터 메시(Data Mesh)는 중앙화된 데이터 팀의 병목을 해소하기 위해 **도메인 주도(Domain-Driven) 분산 데이터 오너십** 원칙을 적용하는 사회·기술적 아키텍처로, 각 비즈니스 도메인이 자체 데이터를 제품(Data Product)으로 소유·관리·제공하는 패러다임이다.
