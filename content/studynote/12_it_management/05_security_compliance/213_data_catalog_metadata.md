...
> **핵심**: 데이터 카탈로그(Data Catalog)는 조직 내 모든 데이터 자산(데이터셋, 테이블, 컬럼, 파이프라인, 리포트)을 **발견·이해·신뢰·접근** 할 수 있도록 비즈니스 메타데이터, 기술 메타데이터, 운영 메타데이터를 통합 태깅하고 검색 가능하게 하는 데이터 자산 관리 시스템이다.
