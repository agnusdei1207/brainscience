...
> **핵심**: RAG (Retrieval-Augmented Generation, 검색 증강 생성) 는 LLM의 고정된 파라메트릭 지식 한계를 외부 지식 베이스 실시간 검색으로 보완하여, 최신·도메인 특화 정보를 환각(Hallucination) 없이 생성할 수 있게 하는 아키텍처 패턴이다.
