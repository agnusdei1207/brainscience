...
> **핵심**: 프롬프트 엔지니어링 (Prompt Engineering) 은 LLM (Large Language Model) 이 원하는 방식으로 응답하도록 입력 텍스트(프롬프트)를 체계적으로 설계·최적화하는 기술로, 모델 가중치를 변경하지 않고 출력 품질을 극적으로 개선하는 "소프트 프로그래밍" 기법이다.
