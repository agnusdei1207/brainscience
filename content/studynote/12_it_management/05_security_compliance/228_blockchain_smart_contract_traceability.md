...
> **핵심**: 스마트 컨트랙트 (Smart Contract) 는 블록체인(Blockchain) 위에서 조건 충족 시 중간자 없이 자동 실행되는 계약 코드로, 공급망 이력(Traceability) 에 적용하면 생산→가공→유통→소비자까지의 전 과정을 위변조 불가능한 방식으로 기록하고 자동 정산한다.
