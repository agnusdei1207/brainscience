...
> **핵심**: BPR(Business Process Reengineering — 비즈니스 프로세스 리엔지니어링)은 기존 프로세스를 '근본부터 재설계'하는 급진적 혁신이고, PI(Process Innovation — 프로세스 혁신)는 한국의 공공기관 맥락에서 BPR과 ISP를 통합한 접근으로, 정보화와 업무 혁신을 동시에 추진한다.
