...
> **핵심**: PERT (Program Evaluation and Review Technique)는 활동의 소요 시간을 낙관치(O), 기대치(M), 비관치(P)의 3가지 확률적 추정치로 산정하고, 가중 평균 공식(O+4M+P)/6으로 기대 완료일과 표준 편차를 계산하는 통계적 일정 관리 기법이다.
