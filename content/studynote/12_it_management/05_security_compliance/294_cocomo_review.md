...
> **핵심**: COCOMO (Constructive Cost Model)는 SW의 규모(LOC 또는 FP)를 입력으로 개발 노력(Person-Month)과 기간을 산정하는 비용 추정 모델로, 유기적(Organic)·준분리형(Semi-detached)·내장형(Embedded) 3가지 유형으로 분류된다.
