...
> **핵심**: Terraform은 선언형으로 인프라 자원을 프로비저닝하고, Ansible은 절차형으로 서버 설정과 구성 관리를 자동화한다.
> **비유**: 집을 새로 짓는 일과, 이미 있는 집에 가구를 배치하는 일은 같은 일이 아니다.
...
적으로 Terraform은 기반을, Ansible은 그 위의 질서를 담당한다.
