...
### 📌 관련 개념 맵
- **[NVMe (Non-Volatile Memory Express)](./509_nvme.md)**: 로컬 호스트용 프로토콜 기초
- **[RDMA (Remote Direct Memory Access)](./510_rdma.md)**: NVMe-oF의 핵심 전송 기술
- **[RoCE (RDMA over Converged Ethernet)](./523_roce.md)**: 이더넷 기반 RDMA 구현체
- **[DPU (Data Processing Unit)](./499_sdi_hardware.md)**: NVMe-oF 오프로딩 가속 하드웨어
