...
- [암호 알고리즘(AES, RSA)](@/studynotes/09_security/02_cryptography/_index.md) : VPN의 기밀성을 보장하는 수학적 근간.
- [OSI 7계층 모델](@/studynotes/03_network/01_network_fundamentals/osi_7_layer.md) : 각 VPN 프로토콜이 동작하는 위치를 정의하는 프레임워크.
- [제로 트러스트(Zero Trust)](@/studynotes/09_security/01_security_management/_index.md) : VPN의 한계를 보완하는 현대 보안의 새로운 패러다임.
- [Firewall & IDS/IPS](@/studynotes/03_network/04_network_security/_index.md) : VPN과 함께 네트워크 경계 방어의 핵심을 이루는 장비.
- [SD-WAN](@/studynotes/03_network/03_network_layer/_index.md) : 소프트웨어 정의 기술을 통해 VPN의 가용성과 성능을 지능적으로 관리하는 기술.
