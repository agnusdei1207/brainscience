...
- [`@/studynotes/03_network/01_network_fundamentals/osi_7_layer.md`](@/studynotes/03_network/01_network_fundamentals/osi_7_layer.md): 5G 프로토콜 스택(PHY, MAC, RLC, PDCP)의 OSI 계층 매핑 및 이해.
- [`@/studynotes/13_cloud_architecture/01_cloud_native/_index.md`](@/studynotes/13_cloud_architecture/01_cloud_native/_index.md): 5G C-RAN 및 Core Network(5GC)의 MSA 및 컨테이너화 아키텍처.
- [`@/studynotes/02_operating_system/01_process_management/cpu_scheduling.md`](@/studynotes/02_operating_system/01_process_management/cpu_scheduling.md): 기지국 MAC 계층에서 다수 사용자의 무선 자원(PRB)을 할당하는 스케줄링 메커니즘과 OS 스케줄링의 유사성.
- [`@/studynotes/10_ai/01_deep_learning/_index.md`](@/studynotes/10_ai/01_deep_learning/_index.md): 6G의 AI-Native Air Interface 진화를 위한 채널 최적화 강화학습 모델과의 연계.
