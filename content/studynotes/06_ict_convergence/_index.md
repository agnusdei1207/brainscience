...
- [`[네트워크와 5G/6G]`](@/studynotes/03_network/_index.md): 데이터 수집(Edge)과 분석(Cloud)을 빛의 속도로 잇는 초저지연 통신망.
- [`[정보 보안 및 제로 트러스트]`](@/studynotes/09_security/_index.md): 수백억 개의 IoT 디바이스가 뚫릴 경우 발생하는 재앙을 막기 위한 철통 방어망.