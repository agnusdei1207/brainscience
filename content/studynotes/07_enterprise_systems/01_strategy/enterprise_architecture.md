...
- [ISP (정보화 전략 계획)](@/studynotes/12_it_management/01_strategy/isp.md): EA 수립의 방향성을 제시하는 IT 마스터플랜.
- [IT 거버넌스 및 COBIT](@/studynotes/12_it_management/01_strategy/it_governance.md): EA를 기반으로 IT 자원을 통제하고 가치를 극대화하는 상위 체계.
- [MSA (마이크로서비스 아키텍처)](@/studynotes/04_software_engineering/01_sdlc/msa.md): 현대 애플리케이션 아키텍처(AA)의 핵심 패러다임.
