...
- [Data Lakehouse](@/studynotes/14_data_engineering/01_data_arch/data_lakehouse.md): 정형/비정형 데이터를 통합 관리하는 저장 계층
- [Master Data Management (MDM)](@/studynotes/07_enterprise_systems/_index.md): 기준 정보의 일관성 확보를 위한 기술
- [Data Catalog](@/studynotes/14_data_engineering/02_governance/_index.md): 데이터의 위치와 상세 정보를 저장하는 저장소
- [Domain-Driven Design (DDD)](@/studynotes/04_software_engineering/01_sdlc/_index.md): Data Mesh 설계의 근간이 되는 모델링 기법
