...
- [OSPF Protocol](@/studynotes/03_network/03_network_layer/routing_algorithms.md): Dijkstra를 활용하는 대표적인 내부 라우팅 프로토콜
- [Graph Database (Neo4j)](@/studynotes/05_database/01_relational_model/nosql.md): 그래프 데이터를 효율적으로 저장하고 탐색하는 NoSQL
