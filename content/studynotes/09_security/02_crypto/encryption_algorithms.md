...
- [공개키 기반 구조 (PKI)](@/studynotes/09_security/01_policy/_index.md) : 비대칭키를 실무에서 신뢰성 있게 배포하기 위한 인증 체계.
- [TLS/SSL 프로토콜](@/studynotes/03_network/01_fundamentals/osi_7_layer.md) : 대칭키와 비대칭키가 융합되어 웹 보안을 실현하는 대표 사례.
