...
- [`[Zero Trust Architecture]`](@/studynotes/09_security/01_security_management/_index.md) : 경계 보안의 한계를 극복하기 위한 현대 보안의 핵심 철학.
- [`[SIEM & SOAR]`](@/studynotes/09_security/01_security_management/_index.md) : 보안 로그를 통합 분석하고 대응을 자동화하는 상위 운영 체계.
- [`[OSI 7 Layer]`](@/studynotes/03_network/01_network_fundamentals/osi_7_layer.md) : 보안 장비가 어느 계층에서 동작하는지 이해하기 위한 기초 이론.
- [`[Web Vulnerabilities (SQLi, XSS)]`](@/studynotes/09_security/02_cryptography/_index.md) : WAF가 주로 방어하는 구체적인 공격 기법들.
