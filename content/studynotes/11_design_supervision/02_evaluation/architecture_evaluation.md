...
- [Design Patterns](@/studynotes/04_software_engineering/01_sdlc_methodology/design_patterns.md): 품질 속성을 해결하기 위한 구체적인 설계 도구
...
- [Microservices Architecture](@/studynotes/04_software_engineering/01_sdlc_methodology/msa.md): 복잡한 품질 트레이드오프가 발생하는 현대적 스타일
