...
- `[Data Lakehouse](@/studynotes/14_data_engineering/01_data_arch/data_lakehouse.md)`: Data Lake의 확장성과 Data Warehouse의 신뢰성을 결합한 최신 데이터 아키텍처.
- `[NoSQL Database](@/studynotes/05_database/01_relational/nosql.md)`: 빅데이터의 다양성(Variety)을 수용하기 위해 고정된 스키마 없이 데이터를 저장하는 DB 기술.
