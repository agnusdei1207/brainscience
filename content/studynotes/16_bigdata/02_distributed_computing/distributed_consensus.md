...
- [Quorum](@/studynotes/16_bigdata/02_distributed_computing/_index.md): 합의를 위해 필요한 최소 노드 수의 원리
- [etcd (Kubernetes Storage)](@/studynotes/13_cloud_architecture/01_cloud_native/kubernetes.md): Raft를 실제로 구현한 대표적 키-값 저장소
- [Saga Pattern](@/studynotes/04_software_engineering/01_sdlc_methodology/msa.md): 합의 알고리즘 없이 긴 트랜잭션을 처리하는 보상 중심 패턴
