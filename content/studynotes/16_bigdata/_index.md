...
- [`[데이터베이스와 트랜잭션]`](@/studynotes/05_database/_index.md): NoSQL과 NewSQL이 극복하고자 하는 전통적인 RDBMS의 한계와 ACID 원리.
...
- [`[알고리즘과 자료구조 (Hash/Tree)]`](@/studynotes/08_algorithm_stats/_index.md): 분산 노드 간의 셔플(Shuffle)을 최소화하고 검색(Index) 속도를 $O(1)$로 압살하는 근본 수학 논리.